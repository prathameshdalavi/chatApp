...
export function RoomCreation() {
    ...
    return (
        <div className="w-full h-screen items-center justify-center flex flex-col bg-gray-800 " >
            <div className="text-4xl font-bold p-2 text-slate-300 ">Welcome to the Chat App </div>
            <div className="text-md  font-semibold pb-2 text-slate-300 "  >Create a room to start chatting with friends. </div>
            <div className="w-96 h-48 p-2 rounded-2xl  mt-4    flex flex-col gap-3  bg-gray-600">
                ...
                <div className="flex text-slate-300 items-center  justify-center">
